...
[css-in-console](../README.md) / error

# Variable: error

> `const` **error**: [`Log`](../interfaces/Log.md)

This is extended version of [nodejs.error](../css-in-console/namespaces/nodejs/functions/error.md) whith CSS-like styling support.
